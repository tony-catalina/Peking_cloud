...
public class UnitcommonlyEntity extends SimpleGenericEntity<String> {

    //alias
    public static final String TABLE_ALIAS = "Unitcommonly";
    ...
    public static final String ALIAS_USERIDS = "用户id";
    ...
    @Length(max = 9999999, message = "单位地址最大长度9999999位", groups = CreateGroup.class)
