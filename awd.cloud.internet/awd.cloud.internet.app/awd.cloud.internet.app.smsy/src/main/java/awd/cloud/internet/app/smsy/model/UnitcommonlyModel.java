...
public class UnitcommonlyModel implements Model{
	...
	public static final String ALIAS_USERIDS = "用户ids";
	...
	public UnitcommonlyModel(){
	}
	public UnitcommonlyModel(String id) {
		this.id = id;
	}
