...
package ${basepackage}.model.logs;
...
public class Logs_${className}Model implements Model{	
...
<#macro generateCompositeIdConstructorIfis>
	...
	<#if table.compositeId>
	public Logs_${className}Model(){
	}
	public Logs_${className}Model(${className}Id id) {
		this.id = id;
	}
	<#else>
