...
package ${basepackage}.model.manager;
...
public class Manager_${className}Model implements Model{	
...
<#macro generateCompositeIdConstructorIfis>
	...
	<#if table.compositeId>
	public Manager_${className}Model(){
	}
	public Manager_${className}Model(${className}Id id) {
		this.id = id;
	}
	<#else>
